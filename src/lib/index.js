class PerformanceAnalyzer {
    ...
    analyzeMe() {
        window.addEventListener("load", () => {
            ...
            let perfObserver = new PerformanceObserver(perfList => {
    ...
    feedData(data) {
        fetch(this.url, {
            ...
            console.info(`Successfully fed data to: ${this.url}`);
        }).catch(err => {
            console.error(`[PerformanceAnalyzer] Cannot feed data to ${this.url}. Reason: ${err}`)
        })
    }
}
